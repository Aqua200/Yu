...
if (user.wafk > -1) {
    conn.reply(m.chat, `${deco1} 𝘿𝙚𝙟𝙖𝙨𝙩𝙚 𝙙𝙚 𝙚𝙨𝙩𝙖𝙧 𝘼𝙁𝙆 ${deco1}\n${user.wafkReason ? `${deco2} 𝙈𝙤𝙩𝙞𝙫𝙤 𝙙𝙚 𝙡𝙖 𝙞𝙣𝙖𝙘𝙩𝙞𝙫𝙞𝙙𝙖𝙙: ` + user.wafkReason : ''}\n\n${deco3} *𝙏𝙞𝙚𝙢𝙥𝙤 𝙞𝙣𝙖𝙘𝙩𝙞𝙫𝙤:* ${(new Date() - user.wafk) / 1000} 𝙨𝙚𝙜𝙪𝙣𝙙𝙤𝙨.`, m);
    user.wafk = -1;
    user.wafkReason = '';
}
...
for (const jid of jids) {
    ...
    if (!mentionedUser || mentionedUser.wafk < 0) continue;
